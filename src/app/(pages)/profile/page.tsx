  ...
  return (
    <>
      ...
      <div className='lg:flex lg:w-full lg:justify-around lg:ml-[15px] lg:mb-[20px]'>
        ...
        <div className='m-[20px] bg-white flex flex-col px-[15px] py-[12px] h-[80vh] justify-start gap-[20%] md:rounded-[12px] md:m-auto md:w-[90%] md:px-[25px]  lg:m-[0px] lg:w-[55%] lg:h-[784px] lg:px-[5%] lg:mr-[15px] lg:relative'>
          <div>
